...
- **ممنوع منعاً باتّاً** إدراج أيّ حديثٍ أو آيةٍ أو دعاءٍ مأثورٍ أو حكمٍ شرعيٍّ ليس منصوصاً في «النص المصدري المعتمد»، ولو كان صحيحاً أو مشهوراً أو داعماً للعبرة. لا تنسب إلى النبيّ ﷺ أو إلى القرآن أيّ لفظٍ ليس في المصدر. إن أردت تعزيز العبرة فبكلام تيتا العاديّ دون نسبته إلى نصٍّ دينيّ.
...
- اجعل عدد المشاهد بين ٢٤ و٣٢ مشهداً (للميزانية)، ولغةً بسيطة رحيمة دون ترويع، وبنشيد خفيف بلا آلات.
- في 🛡️ المراجعة الذاتية: اذكر صراحةً أنّك لم تُدرِج أيّ نصٍّ دينيٍّ خارج المصدر المعتمد.
...
اجعل عدد اللقطات بين ٢٤ و٣٢ لقطة؛ ادمج الأسطر القصيرة المتتابعة لنفس المتحدّث في لقطة واحدة، واجعل أسماء المتحدّثين موحّدة: خالد، نور، تيتا، راوٍ (أو «خالد ونور» ونحوه)، دون استخدام «الراوي».
